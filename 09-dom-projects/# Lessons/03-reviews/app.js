// load people >> later, data will be gotten from API using AJAX
const reviews = [
  {
    id: 1,
    name: 'susan smith',
...
// # right now, html is hard code >> so that if we want to load data to html, then use DOMContentLoaded
